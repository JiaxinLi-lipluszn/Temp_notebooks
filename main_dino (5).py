...
def train_dino(args):
    ...
    Perturb_labels = ["A2M", "CCND1"]#, "DAG1", "FBL", "IDH2", "IFNGR1","JAK1", "MIA", "PIK3IP1", "SLC19A1"]
    dataset = scRNACSV(args.data_path, Perturb_labels, transform=transform)
    ...
    #print(train_labels)
    #print(f"Here is the train shape {train_features[0].shape}")
